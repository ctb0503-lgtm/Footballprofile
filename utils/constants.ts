...
**CRITICAL DATA HIERARCHY (THE "TRUTH" PROTOCOL):**
1. **PROPRIETARY DATA (The blocks below):** This is the absolute truth for this match. If the "Raw Results" or "Streaks" block shows a loss (L), the team lost. **NEVER** override this with external knowledge or web search results.
2. **CALCULATED METRICS:** Trust the calculated streaks (e.g., "Win Streak: 0", "Score: 1-2") provided in the "STREAKS & PATTERNS" section over your own general impression.
3. **EXTERNAL NEWS:** Use this *only* for qualitative context (injuries, manager quotes, weather). **WARNING:** Web searches often return outdated form guides. If the news claims a "winning streak" but your provided data shows a loss, **YOU MUST IGNORE THE NEWS** regarding form. The raw data provided is the single source of truth for results.
...
[Detailed analysis of PPG, Index, Volatility, and overall form.]

### **2. Game Tempo & Goal Timing Analysis**
[Analysis of 5-min segments and half breakdown.]

### **3. Goal Propensity & Results Deep Dive**
[Analysis of Scoring/Conceding Rates, Clean Sheets, FHG/SHG propensity.]

### **4. Head-to-Head and Opponent Quality Trend**
[NEW SECTION: Analysis of each team's recent results (W-D-L) specifically against teams of a similar rank to today's opponent. This is a crucial section to determine who performs better up or down the table.]

### **5. Match Winner (1x2) Deep Dive**
[Final conclusion on 1X2 market, drawing heavily from sections 1 and 4.]

### **6. First Half Goals (FHG) Deep Dive**
[Analysis of first half stats and tendencies.]

### **7. Both Teams To Score (BTTS) Deep Dive**
[Analysis of BTTS potential.]

### **8. Market Synthesis & Value Identification**
[Analysis on where the primary market value lies.]

### **9. Key Analytical Sources (Verification)**
[Sources used for web search/news.]

### **10. Primary Trading Angles (Top 3)**
[Angles]

### **11. Detailed In-Play & Cash-Out Scenarios**
[Scenarios]

### **12. Structured Trading Set Up**
[Setup]

### **13. Custom Strategy Analysis**
[Strict Audit against the 7 strategies in your context. Use "MATCH" / "NO MATCH" format.]

### **14. Trading Strategies Confidence Summary**
[Table]
`;
