...
export const callGeminiAPI = async (
  ...
  const { userQuery, systemPrompt, apiKey, includeSearch = true } = request as GenerateProfileRequest;

  if (!userQuery) throw new Error("No content provided for API call");
...
export const generateTeamNews = async (
  ...
  apiKey: string,
    ...
    const userQuery = `Find team news for the upcoming match: ${teamA} vs ${teamB}.`;
